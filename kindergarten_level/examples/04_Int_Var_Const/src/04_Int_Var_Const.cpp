...
int main() {
	...
	int *pbbb = &bbb;
	cout << "Pointer example : " << pbbb << " (traditional outputs as a hex value)." << endl;
	int *paaa = &aaa;
	cout << "Pointer example main: " << &main << " (traditional outputs as a hex value)." << endl;
	int *ppp = new int;
	cout << "Pointer example: " << ppp << " (traditional outputs as a hex value)." << endl;
	return 0;
}
